...
"fps_max"                     { return new Symbol(sym.FPS_MAX, yyline, yycolumn); }
...
// Ações de movimento
"+frente"                     { return new Symbol(sym.PLUS_FORWARD, yyline, yycolumn); }
"-frente"                     { return new Symbol(sym.MINUS_FORWARD, yyline, yycolumn); }
"+tras"                       { return new Symbol(sym.PLUS_BACK, yyline, yycolumn); }
"-tras"                       { return new Symbol(sym.MINUS_BACK, yyline, yycolumn); }
"+esquerda"                   { return new Symbol(sym.PLUS_LEFT, yyline, yycolumn); }
"-esquerda"                   { return new Symbol(sym.MINUS_LEFT, yyline, yycolumn); }
"+direita"                    { return new Symbol(sym.PLUS_RIGHT, yyline, yycolumn); }
"-direita"                    { return new Symbol(sym.MINUS_RIGHT, yyline, yycolumn); }
"+correr"                     { return new Symbol(sym.PLUS_SPEED, yyline, yycolumn); }
"-correr"                     { return new Symbol(sym.MINUS_SPEED, yyline, yycolumn); }
...
"+atacar2"                    { return new Symbol(sym.PLUS_ATTACK2, yyline, yycolumn); }
"-atacar2"                    { return new Symbol(sym.MINUS_ATTACK2, yyline, yycolumn); }
...
"+mic"                        { return new Symbol(sym.PLUS_VOICERECORD, yyline, yycolumn); }
"-mic"                        { return new Symbol(sym.MINUS_VOICERECORD, yyline, yycolumn); }

// Slots de armas
"slot1"                       { return new Symbol(sym.SLOT1, yyline, yycolumn); }
"slot2"                       { return new Symbol(sym.SLOT2, yyline, yycolumn); }
"slot3"                       { return new Symbol(sym.SLOT3, yyline, yycolumn); }
"slot4"                       { return new Symbol(sym.SLOT4, yyline, yycolumn); }
"slot5"                       { return new Symbol(sym.SLOT5, yyline, yycolumn); }
"slot6"                       { return new Symbol(sym.SLOT6, yyline, yycolumn); }
"slot7"                       { return new Symbol(sym.SLOT7, yyline, yycolumn); }
"slot8"                       { return new Symbol(sym.SLOT8, yyline, yycolumn); }
"slot9"                       { return new Symbol(sym.SLOT9, yyline, yycolumn); }
"slot10"                      { return new Symbol(sym.SLOT10, yyline, yycolumn); }

// Comandos especiais
"toggle_console"              { return new Symbol(sym.TOGGLECONSOLE, yyline, yycolumn); }
"toggle"                      { return new Symbol(sym.TOGGLE, yyline, yycolumn); }
